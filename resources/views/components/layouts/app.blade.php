...
<head>
    ...
    <script src="{{asset('web/assets/js/loader.js')}}"></script>

    <!-- BEGIN GLOBAL MANDATORY STYLES -->
    <link href="https://fonts.googleapis.com/css?family=Nunito:400,600,700" rel="stylesheet">
    <link href="{{asset('web/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{asset('web/assets/css/plugins.css')}}" rel="stylesheet" type="text/css" />
    <!-- END GLOBAL MANDATORY STYLES -->

    <!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM STYLES -->
    <link href="{{asset('web/plugins/apex/apexcharts.css')}}" rel="stylesheet" type="text/css">
    <link href="{{asset('web/assets/css/dashboard/dash_2.css')}}" rel="stylesheet" type="text/css" />

    <!-- END PAGE LEVEL PLUGINS/CUSTOM STYLES -->
        <link rel="stylesheet" href="{{asset('web/assets/css/style.css')}}">
        <link rel="stylesheet" href="{{asset('web/plugins/font-icons/fontawesome/css/fontawesome.css')}}">
...
<body>
        ...
        <header class="header navbar navbar-expand-sm">
            ...
            <ul class="navbar-item theme-brand flex-row  text-center">
                <li class="nav-item theme-logo">
                    <a href="index.html">
                        <img src="{{asset('web/assets/img/logo.svg')}}" class="navbar-logo" alt="logo">
                    </a>
                </li>
            ...
            <ul class="navbar-item flex-row ml-md-auto">
                ...
                <li class="nav-item dropdown language-dropdown">
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle" id="language-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img src="{{asset('web/assets/img/ca.png')}}" class="flag-width" alt="flag">
                    </a>
                    <div class="dropdown-menu position-absolute" aria-labelledby="language-dropdown">
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="{{asset('web/assets/img/de.png')}}" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;German</span></a>
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="{{asset('web/assets/img/jp.png')}}" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;Japanese</span></a>
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="{{asset('web/assets/img/fr.png')}}" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;French</span></a>
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="{{asset('web/assets/img/ca.png')}}" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;English</span></a>
                    </div>
                </li>
                        ...
                        <div class="">
                            ...
                            <a class="dropdown-item">
                                <div class="">
                                    <div class="media">
                                        <div class="user-img">
                                            <img src="{{asset('web/assets/img/profile-15.jpg')}}" class="img-fluid mr-2" alt="avatar">
                                        </div>
                                        <div class="media-body">
                                            <div class="">
                ...
                <li class="nav-item dropdown user-profile-dropdown">
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                        <img src="{{asset('web/assets/img/profile-16.j')}}pg" alt="avatar">
                    </a>
                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>B.M.S</span></li>
                            </ol>
                        </nav>
        ...
        <div id="content" class="main-content">
            ...
            <div class="footer-wrapper">
                <div class="footer-section f-section-1">
                    <p class="">Copyright © 2021 <a target="_blank" href="https://ziainnovatio.com/">Zia Innovations</a>, All rights reserved.</p>
                </div>
    ...
    <script src="{{asset('web/assets/js/libs/jquery-3.1.1.min.js')}}"></script>
    <script src="{{asset('web/bootstrap/js/popper.min.js')}}"></script>
    <script src="{{asset('web/bootstrap/js/bootstrap.min.js')}}"></script>
    <script src="{{asset('web/plugins/perfect-scrollbar/perfect-scrollbar.min.js')}}"></script>
    ...
    <script src="{{asset('web/plugins/apex/apexcharts.min.js')}}"></script>
    <script src="{{asset('web/assets/js/dashboard/dash_2.js')}}"></script>
